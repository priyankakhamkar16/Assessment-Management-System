...
<a href="viewcresult.jsp"><input type="button" value="View Detailed Result" class="home"> </a>
<%
    Connection conn=Connect_File.getConnection();
    String query1="select * from c_answers  where email=? order by sno";
    String query2="select correct_opt from c_questions order by sno";
