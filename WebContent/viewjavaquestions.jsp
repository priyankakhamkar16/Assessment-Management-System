...
%>
    ...
    conn.close();  
    %>
    <a href="updatejavaques.jsp"><input type="button" value="Add Question" class="signout"></a><a href="deletejavaques.jsp"><input type="button" value="Delete Question" class="signout"></a>
</div>
